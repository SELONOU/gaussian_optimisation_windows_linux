...
for xyz_file in extxyz_files:
    ...
    for i, atoms in enumerate(frames):
        ...
        with open(com_path, "w") as f:
            ...
            f.write("0 1\n")  # Assuming charge=0 and multiplicity=1, adjust if necessary

            # Write the atom positions using ASE format
            for atom in atoms:
        ...
        # Move the generated .com file to the new directory 'molecules_g16'
        shutil.move(com_path, os.path.join(molecules_g16_dir, f"{molecule_name}_frame_{i}.com"))

        total_frames += 1

print(f"✅ Wrote {total_frames} .com files from {len(extxyz_files)} .extxyz files into '{molecules_g16_dir}/'")
